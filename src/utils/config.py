...
DISENGAGEMENT_VALENCE_THRESHOLD   = -0.15  # avg_valence below this → low mood
...
NEGATIVE_AFFECT_VALENCE_THRESHOLD = -0.20  # avg_valence below this → tense/anxious
...
OLLAMA_SECONDARY_TIMEOUT = 30   # seconds; Qwen runs in background — longer wait
